...
export const VIDEO_MODEL_MAP = {
  ...
  // ── 2026 新增 3 个 Seedance 子型号（用户抓包确认 Fast VIP = dreamina_seedance_40_vision）──
  // 抓包 root_model="dreamina_seedance_40_vision" benefit_type="dreamina_seedance_20_fast_5s"
  "jimeng-video-seedance-2.0-fast-vip": "dreamina_seedance_40_vision",
  // VIP 版（全能会员通道）：按命名规律应为 _pro_vision（Pro + Vision/Omni）
  "jimeng-video-seedance-2.0-vip": "dreamina_seedance_40_pro_vision",
  // mini 版（极致性价比）：按命名规律应为 _mini
